                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumbs">
                               <ul>
                                   <li><a href="#">Home</a></li>
                                   <li><a href="#">Part Schematics</a></li>
                               </ul>
                            </div>

                            <div class="content">
                                <h1>Part Schematics</h1>
                                ...
                                <div class="product-list part-schematics">
                                      ...
                                      <div class="col-lg-3 col-md-6 product-list-item">
                                         <div class="product-list-box">
                                             ...
                                             <div class="product-list-image">
                                                 ...
                                                 <img src="public/customer/images/img-part-schematics1.png" alt="Image">
                                             </div>
