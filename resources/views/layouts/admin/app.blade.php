...
<head>
    ...
    <meta name="author" content="Hau Nguyena    <meta name="keywords" content="au theme template">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="#">
                            <img src="{{ asset('public/admin/images/icon/img-splash-logo.png') }}" alt="CoolAdmin" />
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list" style="display: none;">
                                ...
                                <li>
                                    <a href="{{ route('pages-new') }}">Create New</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                            <i class="fas fa-copy"></i>Menus</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list" style="display: none;">
                                <li>
                                    <a href="login.html">All Menus</a>
                                </li>
                                <li>
                                    <a href="{{ route('pages-new') }}">Create New</a>
                                </li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                 <i class="fas fa-copy"></i>Menus
                            </a>
                        </li>
                        <!--<li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-binoculars"></i>Products
                            </a>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{ route('webapp-list') }}">Apps</a>
                                </li>
                                <li>
                                    <a href="{{ route('webapp') }}">Create new</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{ route('snippets-list') }}">All Snippet</a>
                                </li>
                                <li>
                                    <a href="{{ Route('snippets') }}">Create New</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="login.html">User Management</a>
                                </li>
                                <li>
                                    <a href="login.html">Product Management</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                            <i class="fas fa-file-text"></i>Templates</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list" style="display: none;">
                                <li>
                                    <a href="{{ route('template-list') }}">All Templates</a>
                                </li>
                                <li>
                                    <a href="{{ route('template-new') }}">Create New</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list" style="display: none;">
                                <li>
                                    <a href="{{ route('pages-list') }}">All Pages</a>
                                </li>
                                <li>
                                    <a href="{{ route('pages-new') }}">Create New</a>
                                </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                @foreach( $apps as $app )
                                    <li>
                                        <a href="{{ route('webapp-item-list',$app->id) }}">{{ $app->name }}</a>
                                    </li>
                                @endforeach
                                <li>
                                    <a href="{{ route('webapp') }}">Create new</a>
                        ...
                        <li class="has-sub">
                            <a href="{{ route('workflow') }}">
                                <i class="fas fa-gears"></i>Manage Workflow
                            </a>
                        </li>
                    </ul>
                </nav>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('public/admin/images/icon/avatar-06.jpg') }}" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('public/admin/images/icon/avatar-04.jpg') }}" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('public/admin/images/icon/avatar-06.jpg') }}" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('public/admin/images/icon/avatar-05.jpg') }}" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('public/admin/images/icon/avatar-04.jpg') }}" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{ asset('public/admin/images/icon/avatar-01.jpg') }}" alt="{{ Auth::user()->name }}" />
                                        </div>
                                        <div class="content">
