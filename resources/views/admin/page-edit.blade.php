            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{ route('pages-update') }}" method="post" style="position: relative; margin-top: .5em;">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="page_id" value="{{ $page->id }}">
                                    <input type="hidden" name="previous_file" value="{{ $page->filename }}">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input name="page_name" type="text" class="form-control" value="{{ $page->name }}" id="pageName" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Page URL</label>
                                                    <div class="input-group">
                                                        <input name="page_url" type="text" class="form-control" value="{{ $page->slug }}" id="pageURL" readonly>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" name="parent" id="parent" required>
                                                           ...
                                                           @foreach( $pages as $p )
                                                                <option value="{{ $p->slug }}" {{$selected = $p->slug == $page->parent ? "selected" : "" }}>{{ $p->name }}</option>
                                                           @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" name="template_id" required>
                                                            @foreach( $templates as $template )
                                                                <option value="{{ $template->id }}" {{ $status = $page->template->id == $template->id ? "selected" : "" }}>{{ $template->template_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6"><br>
                                                    ...
                                                    <div class="input-group">
                                                        <label class="switch switch-3d switch-primary mr-3">
                                                            <input type="checkbox" name="enabled" class="switch-input" {{$status = $page->enabled == 1 ? "checked" : ""}}>
                                                 ...
                                                 <div class="col-6"><br>
                                                    ...
                                                    <div class="input-group">
                                                        <label class="switch switch-3d switch-primary mr-3">
                                                            <input type="checkbox" name="is_homepage" class="switch-input" id="homepage-btn" {{$home = $page->is_homepage == 1 ? "checked" : ""}}>
                                                            <span class="switch-label"></span>
                                                            <span class="switch-handle"></span>
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <textarea name="page_content" id=edit>{{ $content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="meta_title" class="form-control">{{ $page->title }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12">
